...
const TrainingPage = () => {
  return (
    <>
      <Navbar1 />
      <div className="bg-gradient-to-b from-[#00142c] to-[#0EA9AC] text-white min-h-screen px-6 py-10 md:px-10">
        {/* Heading */}
        <motion.h1
          className="text-center text-3xl md:text-4xl font-bold mb-6 pt-20"
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
        >
          Our Trainings & Awareness Programs
        </motion.h1>
  ...
  >
    Empowering Growth Through Training
            ...
            >
              We organize various training and awareness programs aimed at skill development, 
              knowledge sharing, and professional growth. Our initiatives empower individuals 
              with industry-relevant expertise in a dynamic learning environment.
            </motion.p>

            <div className="bg-white/10 p-5 md:p-6 rounded-lg border border-white/20 shadow-md">
              <p className="text-gray-200 leading-relaxed">
                Through our sessions, participants gain hands-on experience, learn from 
                industry experts, and stay updated with the latest trends and innovations. 
                Whether you're a beginner or an expert, our programs help you grow.
              </p>
              <motion.h4
